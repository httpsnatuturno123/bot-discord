...
VALUES (
        ...
        (
            SELECT id
            FROM ceob.organizacoes_militares
            WHERE
                sigla = 'CMD SUP'
        ),
...
-- As funções agora são criadas dinamicamente por OM através do comando /funcao criar
...
VALUES ('v1.0.0_fase1_fundacional') ON CONFLICT (version) DO NOTHING;