...
-- 4. Funções (catálogo pré-cadastrado, expansível)
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_militar_funcao_unica_ativa
    ON ceob.militar_funcoes (militar_id, funcao_id, om_id)
    WHERE ativo = true;
