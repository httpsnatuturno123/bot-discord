class RequerimentoRecrutamentoHandle {
    ...
    async requererRecrutamento({ executadoPorId, robloxId, robloxUsername, nomeGuerra, omSigla, discordId, motivo }) {
        ...
        try {
            ...
            // Opção 1: Criar o militar alvo como inativo para o processo do requerimento
            ...
            const dadosExtras = { patente_inicial: 'REC', om_inicial: omSigla, roblox_username: robloxUsername };
            ...
            const { rows: reqRows } = await client.query(
                ...
                [executadoPorId, militarPendente.id, orgaoResponsavelId, motivo, JSON.stringify(dadosExtras)]
            );
