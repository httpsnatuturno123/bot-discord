...
async function handleRequererRecrutamento(interaction, ceobDb) {
    try {
        ...
        if (msg.includes('Patente')) {
            ...
            respostaUsuario = '❌ **Erro**: Este Roblox ID, Usuário do Discord ou Nome de Guerra já está vinculado a outro militar no sistema.';
        } else {
            respostaUsuario = '❌ Ocorreu um erro interno ao processar seu requerimento.';
        }
