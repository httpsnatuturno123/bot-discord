...
async function handleEfetivo(interaction, ceobDb) {
    try {
        ...
        console.error('Erro no comando efetivo:', error);
        try {
            if (interaction.deferred || interaction.replied) {
                await interaction.editReply('❌ Ocorreu um erro interno ao consultar o efetivo.');
            } else {
                await interaction.reply({ content: '❌ Ocorreu um erro interno ao consultar o efetivo.', ephemeral: true });
            }
        } catch (replyErr) {
